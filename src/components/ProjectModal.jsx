  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full max-w-2xl bg-white/95 backdrop-blur-2xl border border-slate-200 rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-[0_25px_60px_-15px_rgba(15,23,42,0.18)] z-10 max-h-[88vh] overflow-y-auto overscroll-contain no-scrollbar text-slate-800"
      >
        {/* Header */}
        ...
        <div className="py-5 space-y-6 text-xs sm:text-sm text-slate-700">
          ...
          {isFraudProject && (
            <div className="p-4 rounded-2xl bg-slate-50 border border-sky-200 space-y-3 font-mono text-[11px]">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-xs text-sky-700 pb-2 border-b border-sky-100">
          ...
          <div className="flex items-center justify-end gap-2.5 w-full sm:w-auto">
            {project.github && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 sm:flex-initial flex items-center justify-center gap-2 px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-800 text-xs font-medium transition-colors"
              >
            ...
            {project.liveDemo && project.liveDemo !== '#' && project.liveDemo !== project.github && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl bg-slate-950 hover:bg-slate-800 text-white font-semibold text-xs transition-all shadow-md"
              >
