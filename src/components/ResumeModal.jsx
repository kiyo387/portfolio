  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="relative w-full max-w-3xl bg-white/95 backdrop-blur-2xl border border-slate-200/90 rounded-2xl p-4 sm:p-10 shadow-2xl z-10 max-h-[90vh] overflow-y-auto overscroll-contain no-scrollbar print:max-h-none print:overflow-visible print:border-none print:shadow-none print:p-0 print:bg-white print:text-black"
      >
        {/* Top Controls */}
        <div className="flex items-center justify-between pb-4 sm:pb-5 border-b border-slate-200 print:hidden gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 text-xs font-medium transition-colors cursor-pointer"
            >
